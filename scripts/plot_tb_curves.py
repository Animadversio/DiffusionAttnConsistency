...
GROUPS = {
    ...
    "latinsq_rules": {
        "exp_dirs": [
            ...
            "DiT_mini_rowOnly_n6_N4096_onehot_zeromean_autoSD",
            "DiT_mini_sudoku6x6_N4096_onehot_zeromean_autoSD",
        ],
        "tags": [
            "train/loss",
            "eval/full_valid_ratio",
        ...
        "title": "DiT-mini n=6 Rule Complexity Comparison (onehot zero_mean autoSD)",
        "labels": ["Latin square (row+col)", "Row-only", "Sudoku 6×6 (row+col+block)"],
    },
    "latinsq_rules_scalar": {
        "exp_dirs": [
            "DiT_mini_latinSq_n6_N4096_scalar",
            "DiT_mini_rowOnly_n6_N4096_scalar",
            "DiT_mini_sudoku6x6_N4096_scalar",
        ],
        "tags": [
            "train/loss",
            "eval/full_valid_ratio",
        ...
        "title": "DiT-mini n=6 Rule Complexity Comparison (scalar)",
        "labels": ["Latin square (row+col)", "Row-only", "Sudoku 6×6 (row+col+block)"],
    },
    "row_k": {
        "exp_dirs": [
        ...
        "tags": [
            ...
            "train/grad_norm",
            "eval/full_valid_ratio",
            "eval/per_row_valid_ratio",
            "eval/nan_ratio",
            "eval/sample_mem_ratio",
        ],
        "title": "DiT-mini n=6 Row-K Binary Grid Rules (N=4096)",
        "labels": [
            "row_k K=2",
            "row_k K=3",
            "row_var K∈{1,5}",
    ...
    "row_k_global": {
        ...
        "title": "DiT-mini n=6 Global-K Rules — per-K breakdown",
        "labels": ["global_K∈{1,5}", "global_K∈{2,4}"],
    },
    "latinsq_encoding": {
        "exp_dirs": [
